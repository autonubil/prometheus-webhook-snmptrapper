...
const (
	...
	oidPrometheusTrapperFiringNotification      = "1.3.6.1.4.1.39366.9093.0.1" // Notification: firing
	oidPrometheusTrapperRecoveryNotification    = "1.3.6.1.4.1.39366.9093.0.2" // Notification: recovery
	oidPrometheusTrapperNotificationInstance    = "1.3.6.1.4.1.39366.9093.1.1" // Variable: instance
	oidPrometheusTrapperNotificationService     = "1.3.6.1.4.1.39366.9093.1.2" // Variable: service
	oidPrometheusTrapperNotificationLocation    = "1.3.6.1.4.1.39366.9093.1.3" // Variable: location
	oidPrometheusTrapperNotificationSeverity    = "1.3.6.1.4.1.39366.9093.1.4" // Variable: severity
